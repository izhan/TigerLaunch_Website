;(function( $ ) {
	...
	$( document ).on( 'ready', function() {
        ...
        var owl = $("#testimonial-items");
          ...
          $(".round1-btn").click(function(){
            owl.trigger('owl.goTo',0);
            $(".round1-btn").addClass("round-btn-active");
            $(".round2-btn").removeClass("round-btn-active");
            $(".round3-btn").removeClass("round-btn-active");
          })
          $(".round2-btn").click(function(){
            owl.trigger('owl.goTo',1);
            $(".round1-btn").removeClass("round-btn-active");
            $(".round2-btn").addClass("round-btn-active");
            $(".round3-btn").removeClass("round-btn-active");
          })
          $(".round3-btn").click(function(){
